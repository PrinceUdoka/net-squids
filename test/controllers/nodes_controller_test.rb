...
class NodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create node" do
    assert_difference("Node.count") do
      post nodes_url, params: { node: { ip: @node.ip, name: @node.name, network_id: @node.network_id } }
    end
  ...
  test "should update node" do
    patch node_url(@node), params: { node: { ip: @node.ip, name: @node.name, network_id: @node.network_id } }
